 ...
 * Gleitkommazahlen kÃ¶nnen  mit Dezimalpunkt (z.B. 3.24 statt 3,24) eingegeben werden
 *
 * O. Bittel; 24.2.2019
 */
...
public class Tokenizer {
    ...
    /**
     * Liefert den naechsten Token.
     *
     * @return String aus KEYWORDS oder double-Wert, falls das nÃ¤chste Token
    ...
    public Object nextToken() {
        ...
        for (String t : KEYWORDS) {
            if (t.equals(token)) {
                return t;	// String-Konstante wird zurueckgeliefert!
            }
        }
